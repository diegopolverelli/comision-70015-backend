...
router.post('/',(req,res)=>{
    ...
    if(!name){
        ...
        CustomError.createError("name is required", argumentosHeroe(req.body), "complete propiedad name", TIPOS_ERROR.ARGUMENTOS_INVALIDOS)
    }
    ...
    if(!valido){
        ...
        CustomError.createError("invalid properties", argumentosHeroe(req.body), "invalid arguments", TIPOS_ERROR.ARGUMENTOS_INVALIDOS)
    }
